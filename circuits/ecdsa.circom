...
// Implements public key checking algorithm from Johnson et al (Elliptic Curve Digital Signature Algorithm (ECDSA), Johnson et al, section 6.2)
// Checks that the public key is valid point, and that nQ = 0.
template CheckPubkey(n, k) {
    ...
    for (var i = 0; i < 4; i++) {
        lhs.output[1][i] === negative_y.out[i];
    }
}
