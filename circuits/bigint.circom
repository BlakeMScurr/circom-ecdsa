...
template CheckCarryToZero(n, m, k) {
    ...
    for (var i = 0; i < k-1; i++){
        ...
        if (14594172110837393258055670410364002896353171085242198803244477272246392514660 == carry[i] + ( 1<< (m + EPSILON - n - 1))) {
            log(i);
            log(in[i]); // 21859973318809403092699605955058925002631559936803011555347815785216978819506
        }
